...
var g_nCuvint1, g_nCuvint2;
var g_nCuloare1, g_nCuloare2;
var g_nCuloareFond1, g_nCuloareFond2;
var g_bIdentic;
...
function GenerareExercitiu()
{
	...
	g_nCuvint1 = Random(0, 4);
	g_nCuvint2 = Random(0, 4);
	if (Random(0, 1) == 1)
	{
		g_bIdentic = true;
		g_nCuloare2 = g_nCuvint1;
	}
	else
	{
		g_bIdentic = false;
...
function AfisareExercitiu()
{
	...
	if (g_nDificultate == 3)
	{
		g_cContext.fillStyle = cg_asCulori[g_nCuloareFond1];
		g_cContext.fillRect(80.5, 100.5, 240, 100);
		g_cContext.fillStyle = cg_asCulori[g_nCuloareFond2];
		g_cContext.fillRect(320.5, 100.5, 240, 100);
	}

	g_cContext.strokeStyle = "#000000";
	g_cContext.lineWidth = 3;
	g_cContext.strokeRect(80.5, 100.5, 240, 100);
	g_cContext.strokeRect(320.5, 100.5, 240, 100);

	g_cContext.font = "bold 48px Arial";
	g_cContext.textBaseline = "middle";
	g_cContext.textAlign = "center";
	g_cContext.fillStyle = cg_asCulori[g_nCuloare1];
	g_cContext.fillText(cg_asCuvinteCulori[g_nCuvint1], 200, 150);
	g_cContext.fillStyle = cg_asCulori[g_nCuloare2];
	g_cContext.fillText(cg_asCuvinteCulori[g_nCuvint2], 440, 150);
...
function ProcesareRezultate()
{
	...
	sParam += ReprezentareHexa(6);   // ID joc
...
function EvenimentImagineIncarcata()
{
	...
	if (g_nImaginiIncarcate == g_nImaginiDeIncarcat)
	{
		...
		g_cButonIdentic = new Buton(TEXT_BUTON_IDENTIC, 236, 288, IMG_BUTON_TEXT);
		g_cButonDiferit = new Buton(TEXT_BUTON_DIFERIT, 404, 288, IMG_BUTON_TEXT);
...
function AfisareRezultate()
{
	...
	g_cContext.fillText(TEXT_DENUMIRE_JOC_006, 340, 30);
